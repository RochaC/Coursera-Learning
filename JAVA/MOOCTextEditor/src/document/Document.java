...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		float numWords = this.getNumWords();
		float numSentences = this.getNumSentences();
		float numSyllables = this.getNumSyllables();
		
		float score = (float) (206.835-1.015*(numWords/numSentences)-84.6*(numSyllables/numWords));
	    return score;
	}
