		...
		for(int index = 0; index < s.length(); index++){
			for(int charCode = (int)'a'; charCode <= (int)'z'; charCode++) {
				...
				if(!currentList.contains(sb.toString()) && 
					...
					System.out.println("substitution distance: " + sb.toString());
				}
			}
		}
	}
...
//				System.out.println(sb);
				...
				if(!currentList.contains(sb.toString()) &&
						(!wordsOnly || dict.isWord(sb.toString()))){
					currentList.add(sb.toString());
					System.out.println("Insertion distance: " + sb.toString());
				}
...
//				System.out.println(sb);
				...
				if(!currentList.contains(sb.toString()) &&
						(!wordsOnly || dict.isWord(sb.toString()))){
					currentList.add(sb.toString());
					System.out.println("Deletions distance: " + sb.toString());	
				}
		}
	}
...
//			System.out.println("In the while ");
			List<String> tmp = distanceOne(w,true);

			for(String n:tmp){
				System.out.println("Process string:" + n);
				if(!visited.contains(n)){
					visited.add(n);
					queue.add(n);
					if(dict.isWord(n)){
						retList.add(n);
						System.out.println("word to suggest: " + n);
					}
				}
			}
